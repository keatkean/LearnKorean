  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto p-3 sm:p-6 flex flex-col gap-4">
        ...
        <div className="bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-800 rounded-xl p-3 sm:p-4 text-xs sm:text-sm text-slate-600 dark:text-gray-400 flex items-center justify-between gap-2 shadow-sm">
